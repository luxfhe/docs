...
* [What is Torus?](get-started/readme.md)
...
* [Part I: Torus - FHE compiler](https://www.lux.network/post/zama-torus-fully-homomorphic-encryption-compiler)
* [Part II: The Architecture of Torus](https://www.lux.network/post/the-architecture-of-torus-zama-fully-homomorphic-encryption-compiler-leveraging-mlir)
...
* [Contributing](dev/contributing.md)
  ...
  * [MLIR FHE dialects](explanations/dialects.md)
    ...
    * [Torus dialect](explanations/TorusDialect.md)
...
* [Release note](https://github.com/luxfi/torus/releases)
* [Feature request](https://github.com/luxfi/torus/issues/new?assignees=\&labels=feature\&projects=\&template=features.md)
* [Bug report](https://github.com/luxfi/torus/issues/new?assignees=\&labels=bug%2C+triage\&projects=\&template=bug_report.md)
