# Compression
This document explains the compression feature in **Torus** and its performance impact.
...
Currently, **Torus** uses the seeded compression algorithms. These algorithms rely on the fact that CSPRNGs are deterministic. Consequently, the chain of random values can be replaced by the seed and later recalculated using the same seed.
