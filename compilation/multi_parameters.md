# Multi parameters
This document explains the implications and configuration of multi parameters in **Torus**.

In **Torus**, integers are encrypted and processed based on a set of cryptographic parameters. By default, the **Torus** optimizer selects multiple sets of these parameters, which may not be optimal for every use case. In such cases, you can choose to use mono parameters instead.
