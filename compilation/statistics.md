# Statistics
This document provides an overview of how to analyze compiled circuits and extract statistical data for performance evaluation in **Torus**. These statistics help identify bottlenecks and compare circuits.

## Basic operations
Torus calculates statistics based on the following six basic operations:
