# Bit Extraction
This document provides an overview of the bit extraction feature in **Torus**, including usage examples, limitations, and performance considerations. 
...
- **Float bit extraction is not supported**: While Torus supports floats to some extent, bit extraction is not possible on float types.
