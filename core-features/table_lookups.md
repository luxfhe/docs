...
This document introduces the concept of Table Lookups (TLUs) in **Torus**, covers the basic TLU usage, performance considerations, and some basic techniques for optimizing TLUs in encrypted computations. For more advanced TLU usage, refer to the [Table Lookup advanced](table_lookups_advanced.md) section
...
In many cases, you won't need to define your own TLUs, as Torus will set them for you.
