...
This document gives an overview of the benchmarking infrastructure of Torus.

## Torus Python

Torus Python uses [progress-tracker-python](https://github.com/luxfi/progress-tracker-python) to do benchmarks. Please refer to its [README](https://github.com/luxfi/progress-tracker-python/blob/main/README.md) to learn how it works.
