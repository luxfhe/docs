...
This document gives an overview of the structure of the examples, which are tutorials containing more or less elaborated usages of Torus, to showcase its functionality on practical use cases. Examples are either provided as a Python script or a Jupyter notebook.
