...
**Torus** includes an artifact system that simplifies the debugging process by automatically or manually exporting detailed information during compilation failures.
...
This function fails to compile because **Torus** does not support floating-point outputs. When you try to compile it, an exception will be raised and the artifacts will be exported automatically. The following files will be generated in the `.artifacts` directory:
...
Traceback (most recent call last):
  ...
  File "/usr/local/lib/python3.10/site-packages/torus/fhe/mlir/graph_converter.py", line 240, in _check_graph_convertibility
...
- **`client\_parameters.json`**: Information about the client parameters chosen by **Torus**.
...
You can seek help with your issue by asking a question directly in the [community forum](https://community.lux.network/).

## Submitting an issue

If you cannot find a solution in the community forum, or if you have found a bug in the library, you could [create an issue](https://github.com/luxfi/torus/issues/new/choose) in our GitHub repository.

For [bug reports](https://github.com/luxfi/torus/issues/new?assignees=&labels=bug%2C+triage&projects=&template=bug_report.md), try to:
...
For [feature requests](https://github.com/luxfi/torus/issues/new?assignees=&labels=feature&projects=&template=features.md), try to:
