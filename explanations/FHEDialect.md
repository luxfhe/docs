...
### `FHE.add_eint_int` (::mlir::toruslang::FHE::AddEintIntOp)
...
### `FHE.add_eint` (::mlir::toruslang::FHE::AddEintOp)
...
### `FHE.apply_lookup_table` (::mlir::toruslang::FHE::ApplyLookupTableEintOp)
...
### `FHE.and` (::mlir::toruslang::FHE::BoolAndOp)
...
### `FHE.nand` (::mlir::toruslang::FHE::BoolNandOp)
...
### `FHE.not` (::mlir::toruslang::FHE::BoolNotOp)
...
### `FHE.or` (::mlir::toruslang::FHE::BoolOrOp)
...
### `FHE.xor` (::mlir::toruslang::FHE::BoolXorOp)
...
### `FHE.change_partition` (::mlir::toruslang::FHE::ChangePartitionEintOp)
...
| :-------: | :-------: | ----------- |
| `src` | ::mlir::toruslang::FHE::PartitionAttr | An attribute representing a partition.
| `dest` | ::mlir::toruslang::FHE::PartitionAttr | An attribute representing a partition.
...
### `FHE.from_bool` (::mlir::toruslang::FHE::FromBoolOp)
...
### `FHE.gen_gate` (::mlir::toruslang::FHE::GenGateOp)
...
### `FHE.lsb` (::mlir::toruslang::FHE::LsbEintOp)
...
### `FHE.max_eint` (::mlir::toruslang::FHE::MaxEintOp)
...
### `FHE.mul_eint_int` (::mlir::toruslang::FHE::MulEintIntOp)
...
### `FHE.mul_eint` (::mlir::toruslang::FHE::MulEintOp)
...
### `FHE.mux` (::mlir::toruslang::FHE::MuxOp)
...
### `FHE.neg_eint` (::mlir::toruslang::FHE::NegEintOp)
...
### `FHE.reinterpret_precision` (::mlir::toruslang::FHE::ReinterpretPrecisionEintOp)
...
### `FHE.round` (::mlir::toruslang::FHE::RoundEintOp)
...
### `FHE.sub_eint_int` (::mlir::toruslang::FHE::SubEintIntOp)
...
### `FHE.sub_eint` (::mlir::toruslang::FHE::SubEintOp)
...
### `FHE.sub_int_eint` (::mlir::toruslang::FHE::SubIntEintOp)
...
### `FHE.to_bool` (::mlir::toruslang::FHE::ToBoolOp)
...
### `FHE.to_signed` (::mlir::toruslang::FHE::ToSignedOp)
...
### `FHE.to_unsigned` (::mlir::toruslang::FHE::ToUnsignedOp)
...
### `FHE.zero` (::mlir::toruslang::FHE::ZeroEintOp)
...
### `FHE.zero_tensor` (::mlir::toruslang::FHE::ZeroTensorOp)
