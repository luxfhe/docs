...
### `RT.await_future` (::mlir::toruslang::RT::AwaitFutureOp)
...
### `RT.build_return_ptr_placeholder` (::mlir::toruslang::RT::BuildReturnPtrPlaceholderOp)
...
### `RT.clone_future` (::mlir::toruslang::RT::CloneFutureOp)
...
### `RT.create_async_task` (::mlir::toruslang::RT::CreateAsyncTaskOp)
...
### `RT.dataflow_task` (::mlir::toruslang::RT::DataflowTaskOp)
...
### `RT.dataflow_yield` (::mlir::toruslang::RT::DataflowYieldOp)
...
### `RT.deallocate_future_data` (::mlir::toruslang::RT::DeallocateFutureDataOp)
...
### `RT.deallocate_future` (::mlir::toruslang::RT::DeallocateFutureOp)
...
### `RT.deref_return_ptr_placeholder` (::mlir::toruslang::RT::DerefReturnPtrPlaceholderOp)
...
### `RT.deref_work_function_argument_ptr_placeholder` (::mlir::toruslang::RT::DerefWorkFunctionArgumentPtrPlaceholderOp)
...
### `RT.make_ready_future` (::mlir::toruslang::RT::MakeReadyFutureOp)
...
### `RT.register_task_work_function` (::mlir::toruslang::RT::RegisterTaskWorkFunctionOp)
...
### `RT.work_function_return` (::mlir::toruslang::RT::WorkFunctionReturnOp)
