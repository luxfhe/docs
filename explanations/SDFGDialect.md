...
### `SDFG.get` (::mlir::toruslang::SDFG::Get)
...
### `SDFG.init` (::mlir::toruslang::SDFG::Init)
...
### `SDFG.make_process` (::mlir::toruslang::SDFG::MakeProcess)
...
| :-------: | :-------: | ----------- |
| `type` | ::mlir::toruslang::SDFG::ProcessKindAttr | Process kind
...
### `SDFG.make_stream` (::mlir::toruslang::SDFG::MakeStream)
...
| `type` | ::mlir::toruslang::SDFG::StreamKindAttr | Stream kind
...
### `SDFG.put` (::mlir::toruslang::SDFG::Put)
...
### `SDFG.shutdown` (::mlir::toruslang::SDFG::Shutdown)
...
### `SDFG.start` (::mlir::toruslang::SDFG::Start)
...
```
#SDFG.process_kind<
  ::mlir::toruslang::SDFG::ProcessKind   # value
>
```
...
| :-------: | :-------: | ----------- |
| value | `::mlir::toruslang::SDFG::ProcessKind` | an enum of type ProcessKind |
...
```
#SDFG.stream_kind<
  ::mlir::toruslang::SDFG::StreamKind   # value
>
```
...
| Parameter | C++ type | Description |
| :-------: | :-------: | ----------- |
| value | `::mlir::toruslang::SDFG::StreamKind` | an enum of type StreamKind |
