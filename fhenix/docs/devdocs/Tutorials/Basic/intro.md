...
We'll be making use of the FHE library and luxfhe Nitrogen Testnet to enable this functionality - it allows us to perform computations on encrypted data without first having to decrypt it, which is vital for preserving privacy.

You can find all the completed code in our [example project repository](https://github.com/luxfheProtocol/erc20-tutorial-code). You can just skip there if you just want to see the final code.

[//]: # "This example focuses on Javascript. If you're more of a python fan, check out the workshop available here: [https://github.com/luxfhe.io/ethcc23-workshop](https://github.com/luxfhe.io/ethcc23-workshop)"
