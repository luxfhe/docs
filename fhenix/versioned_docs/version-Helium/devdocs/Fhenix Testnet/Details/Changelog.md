...
Here you can find a list of changes between different versions of the luxfhe Testnet(s) as we evolve and grow.
...
* All client-side libraries and toolkits have been upgraded and will require an update to version 0.2 to work with Helium - luxfheJS, Remix plugin & hardhat plugins.
...
* Localluxfhe - Added support for `Console.log` functionality to allow debug logs during contract execution. 
