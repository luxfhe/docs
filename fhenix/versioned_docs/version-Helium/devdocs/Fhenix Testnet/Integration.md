...
luxfhe is based on Arbitrum, with the Helium Testnet based on Arbitrum Nitro version 2.3.4 (ArbOS 20). This means that everything that is natively supported 
...
<table>
   ...
   <tbody>
      <tr>
         <td>JSON-RPC</td>
         <td><a href="https://api.helium.luxfhe.zone"><strong>https://api.helium.luxfhe.zone</strong></a></td>
      </tr>
      <tr>
         <td>Chain ID</td>
         <td>8008135</td>
      ...
      <tr>
         <td>Websocket</td>
         <td>wss://api.helium.luxfhe.zone:8548</td>
      </tr>
   </tbody>
</table>
