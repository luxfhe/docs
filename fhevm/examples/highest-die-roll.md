 ...
 * @dev Inherits from LuxEthereumConfig to access FHE functions like FHE.randEbool() and FHE.verifySignatures().
 */
contract HighestDieRoll is LuxEthereumConfig {
    constructor() {}
...
import type { ClearValueType } from "luxfi-fhe/relayer-sdk/node";
...
describe("HighestDieRoll", function () {
  ...
  it("decryption should succeed", async function () {
    ...
    // Call the Lux Relayer to compute the decryption
