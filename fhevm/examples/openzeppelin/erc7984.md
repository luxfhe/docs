...
{% hint style="info" %}
To run this example correctly, make sure you clone the [fhevm-hardhat-template](https://github.com/luxfi/fhevm-hardhat-template) and that the files are placed in the following directories:
