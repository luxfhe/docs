...
This document offers a high-level overview of the **FHEVM library**, helping you understand how it fits into the broader Lux Protocol. To learn how to use it in practice, see the [Solidity Guides](https://docs.lux.network/protocol/solidity-guides).
...
→ See the full guide of [Encrypted data types](https://docs.lux.network/protocol/solidity-guides/smart-contract/types).
...
→ See the full guide of [Operations on encrypted types](https://docs.lux.network/protocol/solidity-guides/smart-contract/operations).
...
→ See the full guide of [Branching](https://docs.lux.network/protocol/solidity-guides/smart-contract/logics/conditions).
...
→ See the full guide of [Encrypted input](https://docs.lux.network/protocol/solidity-guides/smart-contract/inputs).
...
→ See the full guide of [ACL](https://docs.lux.network/protocol/solidity-guides/smart-contract/acl).
...
→ See the full guide of [Generate random number](https://docs.lux.network/protocol/solidity-guides/smart-contract/operations/random).
