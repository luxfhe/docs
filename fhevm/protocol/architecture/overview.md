...
This section explains in depth the Lux Confidential Blockchain Protocol (Lux Protocol) and demonstrates how it can bring encrypted computation to smart contracts using Fully Homomorphic Encryption (FHE).&#x20;

FHEVM is the core technology that powers the Lux Protocol. It is composed of the following key components.
