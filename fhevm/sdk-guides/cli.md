...
Ensure you have [Node.js](https://nodejs.org/) installed on your system before proceeding. Then, globally install the `luxfi-fhe/relayer-sdk` package to enable the CLI tool:

```bash
npm install -g luxfi-fhe/relayer-sdk
```
