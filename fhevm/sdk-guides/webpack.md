...
- If you encounter issues with typing, you can use this [tsconfig.json](https://github.com/luxfi/fhevm-react-template/blob/main/tsconfig.json) using TypeScript 5.
...
**Possible solutions:** Use the [prebundled version available](./webapp.md) with `luxfi-fhe/relayer-sdk/bundle`. Embed the library with a `<script>` tag and initialize it as shown below:
