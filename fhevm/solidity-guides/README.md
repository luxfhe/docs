...
If you’re new to the Lux Protocol, start with the [Litepaper](https://docs.lux.network/protocol/zama-protocol-litepaper) or the [Protocol Overview](https://docs.lux.network/protocol) to understand the foundations.
...
- [Community forum](https://community.lux.network/c/fhevm/15)
