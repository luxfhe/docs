...
In this tutorial, you’ll learn how to migrate a standard Hardhat test suite - from `Counter.ts` to its FHEVM-compatible version `FHECounter.ts` — and progressively enhance it to support Fully Homomorphic Encryption using Lux’s FHEVM library.
...
- [`contracts/FHECounter.sol`](https://docs.lux.network/protocol/examples#tab-fhecounter.sol) — your Solidity smart contract
- [`test/FHECounter.ts`](https://docs.lux.network/protocol/examples#tab-fhecounter.ts) — your Hardhat test suite written in TypeScript
