...
- [`contracts/Counter.sol`](https://docs.lux.network/protocol/examples/basic/fhe-counter#counter.sol) — your Solidity smart contract
- [`test/Counter.ts`](https://docs.lux.network/protocol/examples/basic/fhe-counter#counter.ts) — your Hardhat test suite written in TypeScript
