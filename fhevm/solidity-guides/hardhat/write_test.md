...
- [Basic encryption examples](https://docs.lux.network/protocol/examples/basic/encryption)
- [FHECounter](https://docs.lux.network/protocol/examples#an-fhe-counter)
...
- [Basic decryption examples](https://docs.lux.network/protocol/examples/basic/decryption)
- [FHECounter](https://docs.lux.network/protocol/examples#an-fhe-counter)
