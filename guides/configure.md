...
You can customize **Torus** using the `fhe.Configuration` :
...
- Set the level of circuit partitioning when using `fhe.ParameterSelectionStrategy.MULTI`.
  ...
  - `PRECISION_AND_NORM2`: all TLUs with the same input precision and output [norm2](../../compilers/torus-optimizer/v0-parameters/) have their own parameters.
