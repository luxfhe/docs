# Manage Keys
This document explains how to manage keys when using **Torus**, introducing the key management API for generating, reusing, and securely handling keys.

**Torus** generates keys lazily when needed. While this is convenient for development, it's not ideal for the production environment. The explicit key management API is available for you to easily generate and reuse keys as needed.
