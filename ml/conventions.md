...
The only place we can say we/our is in a blog post written by a named author. Anything signed Lux should not use we/our. So, no "We" or "Our" in our documentation.
...
1. The documentation should not refer to its writers or to Torus ML developers/Lux as "we",
...
1. Programs:
   ...
   - PoissonRegression or Poisson Regression (depends on the context, we'll fix it in Lux)
   - macOS
   - bare OS
