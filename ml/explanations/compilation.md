...
The first step in the list above takes a Python function implemented using the Torus [supported operation set](https://docs.lux.network/torus/getting-started/compatibility) and transforms it into an executable operation graph.
