...
- **Kaggle installation**: Torus ML can be installed on Kaggle ([see question on community for more details](https://community.lux.network/t/how-do-we-use-torus-ml-on-kaggle/332)) and on Google Colab.
...
If you encounter any issue during installation on Apple Silicon mac, please visit this [troubleshooting guide on community](https://community.lux.network/t/troubleshooting-torus-installation-on-apple-silicon/577).
...
```shell
docker pull zamafhe/torus-ml:latest
# or
docker pull zamafhe/torus-ml:v0.4.0
```
...
docker run --rm -it -p 8888:8888 zamafhe/torus-ml

# With local volume to save notebooks on host:
docker run --rm -it -p 8888:8888 -v /host/path:/data zamafhe/torus-ml
```
...
```shell
docker run --rm -it zamafhe/torus-ml /bin/bash
```
