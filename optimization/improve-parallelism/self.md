...
This guide introduces the different options for parallelism in **Torus** and how to utilize them to improve the execution time of **Torus** circuits.
...
There are two kinds of parallelism in **Torus**:
