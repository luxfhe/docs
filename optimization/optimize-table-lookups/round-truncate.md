...
This guide teaches how to improve the execution time of Torus circuits by using some special operations that reduce the bit width of the input of the table lookup.
