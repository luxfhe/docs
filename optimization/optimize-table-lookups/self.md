...
This guide teaches how costly table lookups are, and how to optimize them to improve the execution time of Torus circuits.

The most costly operation in Torus is the table lookup operation, so one of the primary goals of optimizing performance is to reduce the amount of table lookups.
